...
PICS = (environ.get('PICS', 'https://graph.org/file/f5c2ca188491f462e192b-4df7945a9f14060600.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5121200840').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002756814383'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002439028662').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002836382668') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002775251036')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://RayneWil:Jack5656@cluster0.v053usu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "CineMoviezBot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'CineMoviezCollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/CineMoviezGroup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/CineMoviezChannel')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CineMoviezGroup') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/The_Jack1')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'c8e8de4a2918fcb65af56a43dd0b67e24fcc2e3e')
...
QUALITIES = ["480p", "720p", "1080p", "1440p"]
