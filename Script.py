...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ.sᴏ ᴘʟᴇᴀsᴇ sᴇɴᴅ ʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɪɴ ɢʀᴏᴜᴘ ᴡɪᴛʜ ʀᴇǫᴜᴇsᴛ ғᴏʀᴍᴇᴛ! 
    #ʀᴇǫᴜᴇsᴛ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ 
    ʏᴇᴀʀ (ᴇx- 𝟸𝟶𝟷𝟽) 
    ʟᴀɴɢᴜᴀɢᴇ
    
    ᴀɴᴅ ᴅᴏɴᴇ ✅ ᴡᴀɪᴛ ғᴏʀ sᴏᴍᴇᴛɪᴍᴇ..."""

    TOP_ALRT_MSG = """Cʜᴇᴄᴋɪɴɢ Fᴏʀ Mᴏᴠɪᴇ Iɴ Dᴀᴛᴀʙᴀsᴇ..."""

    MELCOW_ENG = """<b>Hᴇʟʟᴏ {} 😍, Aɴᴅ Wᴇʟᴄᴏᴍᴇ Tᴏ ᴏᴜʀ {} Gʀᴏᴜᴘ ❤️</b>"""
